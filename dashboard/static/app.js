...
fetch('/api/data')
    ...
    .then(data => {
        ...
        const pieChart = d3.select("#pie-chart")
            .append("g")
            .attr("transform", "translate(200,150)"); // Adjusted to center the pie chart in the middle
        ...
        const legend = d3.select("#pie-chart")
            .append("g")
            .attr("transform", "translate(80, 280)"); // Move the legend below the pie chart by 100px more
        ...
        legend.selectAll("rect")
            ...
            .enter()
            .append("rect")
            .attr("x", (d, i) => i * 80) // Horizontal spacing between legend items
            .attr("y", 0)
            .attr("width", 20)
            .attr("height", 20)
            .attr("fill", d => d.color);
        ...
        legend.selectAll("text")
            ...
            .enter()
            .append("text")
            .attr("x", (d, i) => i * 80 + 30) // Position text next to the color boxes
            .attr("y", 15)
            .attr("font-size", "12px")
            .text(d => d.label);
        ...
        const xScale = d3.scaleBand()
            .domain(dates)
            .range([0, width])
            .padding(0.1); // You can adjust this padding value to control the space between bars
